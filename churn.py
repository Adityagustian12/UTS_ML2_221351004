...
# Load model TFLite
interpreter = tf.lite.Interpreter(model_path="churn_model.tflite")
...
# Input sebagai array
input_data = np.array([[credit_score, age, tenure, balance, num_products, has_cr_card, is_active_member, estimated_salary]])
